<table class="tb_menu_inicial" align="center">
	<tr>
		...
		<?php
			...
			echo '<a href="index.php?pagina=perfil"><img class="img_func" src="imagem_f.php?idfuncionario='.$_COOKIE['id_funcionario'].'"></a><br><font class="txt_func">'.mysql_result($r_func,0,0).'</font><br><br>';

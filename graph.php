...
require('config.php'); //carregar variaveis globais
	...
	$q_horas_graph="select date(data),sum(horas_viatura),sum(mov_viatura.transporte) from mov_viatura where id_funcionario=".$_COOKIE['id_funcionario']." group by day(data) order by date(data) desc limit 7";
